...
import com.hw20.R
import com.hw20.databinding.FragmentMakingPhotosBinding
import com.hw20.presentation.fragments.photos.viewModel.MakingPhotosViewModel
import com.hw20.presentation.fragments.photos.viewModel.MakingPhotosViewModelFactory
...
class MakingPhotosFragment : Fragment() {
    ...
    private val launcher = registerForActivityResult(
        ...
        if (map.values.all { it }) {
            ...
            Toast.makeText(
                requireContext(), getString(R.string.permission_is_not_granted),
                Toast.LENGTH_SHORT
            ).show()
        }
    }
